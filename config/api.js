...
// 线上云平台api地址
var WxApiRoot = 'https://wxapi.91bkw.com/wechat/';

module.exports = {
  WxApiRoot :'https://wxapi.91bkw.com/wechat/',
  ...
  //新增
  weChatMini:WxApiRoot + '/wechat/login/weChatMini' ,//解密微信绑定手机号后登录
  sendsms:WxApiRoot + '/wechat/login/sendsms' ,//获取短信验证码
  memberlogin:WxApiRoot + '/wechat/login/member' ,//短信登录
};